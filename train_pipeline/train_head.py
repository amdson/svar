...
python train_pipeline/train_head.py --cache checkpoints/sativas413_embeddings.ckpt.pt --head mlp --epochs 50 --lr 1e-3 --warm-start-standardizer --output trained_heads/mlp_sum/model.pt
"""
import argparse
import sys
