...
DEFAULT_DNABERT2    = "zhihan1996/DNABERT-2-117M"
DEFAULT_PLANTCAD    = "kuleshov-group/PlantCaduceus_l32"
...
if args.model_path is None:
    args.model_path = (
        DEFAULT_DNABERT2 if args.backend == "dnabert2" else DEFAULT_PLANTCAD
    )
...
if args.backend == "dnabert2":
    ...
    model, tokenizer = load_plantcad(repo_id=args.model_path, device=device)
